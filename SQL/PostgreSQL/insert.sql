...
INSERT INTO ucessuv.post_harvest_storage (post_harvest_storage_id, post_harvest_storage_name, post_harvest_storage_type, built_date, location)
VALUES 
...
INSERT INTO ucessuv.seed_storage (seed_storage_id, post_harvest_storage_id, seed_storage_name, seed_storage_type, location)
VALUES
    (
        1,
        (
            SELECT post_harvest_storage_id 
            FROM ucessuv.post_harvest_storage b 
...
-- Inserts for 'seed_stations' table
INSERT INTO ucessuv.seed_stations
...
INSERT INTO ucessuv.testers (tester_id, tester_name)
VALUES 
    (1, 'Peter'),
    (2, 'Alice'),
    (3, 'John'),
...
INSERT INTO ucessuv.condition_indicator (condition_indicator_id, condition_indicator_description)
VALUES 
    (1, 'most_suitable'),
    (2, 'suitable'),
    (3, 'not_suitable');
...
INSERT INTO ucessuv.seed_storage_condition (seed_storage_condition_id, seed_storage_id, temperature_condition, tester_id, report_date)
VALUES 
    (1, 1, 3, 1, '2023-05-15'),
    (2, 2, 2, 2, '2023-05-01'),
    (3, 3, 1, 3, '2023-05-31'),
...
INSERT INTO ucessuv.seed_stations_condition (seed_station_id, size_condition, moisture_condition, genetic_purity_condition, tester_id, report_date)
VALUES 
...
INSERT INTO ucessuv.parameters
